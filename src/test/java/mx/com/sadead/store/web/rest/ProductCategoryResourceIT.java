...
import mx.com.sadead.store.repository.ProductCategoryRepository;
import mx.com.sadead.store.repository.search.ProductCategorySearchRepository;
import mx.com.sadead.store.service.ProductCategoryService;
...
public class ProductCategoryResourceIT {
     ...
     *
     * @see mx.com.sadead.store.repository.search.ProductCategorySearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void updateProductCategory() throws Exception {
        ...
        reset(mockProductCategorySearchRepository);
